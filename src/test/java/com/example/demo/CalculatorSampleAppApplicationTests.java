...
public class CalculatorSampleAppApplicationTests {
        ...
        //newly-added test
         @Test
        public void calcAdd3() {
            Calculator c = new Calculator(5, 1, 1, "+"); //Arrange
            double result = c.calculateResult(); //Act
            assertEquals(7.0, result, 0.000001); //Assert
        }
      
        //newly-added test
        @Test
        public void calcMult3() {
            Calculator c = new Calculator(5, 1, 1, "*"); //Arrange
            double result = c.calculateResult(); //Act
            assertEquals(5.0, result, 0.000001); //Assert
        }
        ...
        //newly-added test
        @Test
        public void calcSub3() {
            Calculator c = new Calculator(5, 1, 1, "-"); //Arrange
            double result = c.calculateResult(); //Act
            assertEquals(3.0, result, 0.000001); //Assert
        }
        
        //newly-added test
        //a parammeterized test allows a developer to run the same test over 
        //and over again using different values?
        @Test
        public void calcAddParameterised3() {
            Calculator c = new Calculator(2, 3, 1, "+"); //Arrange
            double result = c.calculateResult(); //Act
            assertEquals(6.0, result, 0.000001); //Assert
        }
